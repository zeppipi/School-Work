...
last modified date: May 5th 2022
...
alter table enrolment disable constraint en_unit_code_fk;
...
alter table enrolment enable constraint en_unit_code_fk;
commit;
select * from unit;
select * from enrolment;
